  ...
  class Command
    class This < Command
      ...
      def run
        ...
        raise Objctify::Informative, "Couldn't find Objctifile" unless File.exist?(file_path)
        ...
        unless project.j2objc_config.prefixes_file_path.nil?
          raise Objctify::Informative, "Specified prefixes files does not exist: #{project.j2objc_config.prefixes_file_path}" unless File.exist?(project.j2objc_config.prefixes_file_path)
